...
define(function() {
	 ...
	 * This function will corrupt the original array Proper usage:a=Set(a);
	 * 
	 * @param {ArrayLike} a
	 * @param {Set} _sorted return new ArrayLike Set
	 */
	...
	/**
	 * Shell sort, Return sorted Set.
	 * This function will corrupt the original array Proper usage: a=sortUnique(a);
	 * 
	 * @param {ArrayLike} a
	...
	/**
	 * Object id unique.
	 * This function will corrupt the original array, Correct usage: a=idUnique(a);
	 * 
	 * @param {[Object]} a NonPrimitive Array
	 */
	function idUnique(a) {
		var i, j, l = a.length, p;
		var guid = (Math.random() * 1E10).toString(32) + (+new Date).toString(32);
		for (i = j = 0; i < l; i++) {
			p = a[i];
			if (p == null) continue;
	 ...
	 * 		map: OriginalRangesToDisjoinRangesMap
	 * }
