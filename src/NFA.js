        ...
        fromStates.forEach(function (from) {
            ...
            trans.forEach(function (t) {
                if (t.eMove) {
                    ...
                    K.flatten2(t.ranges.map(function (r) {
                        return rangeMap[r]
                    })).forEach(function (r) {
            ...
            ranges = K.Set(cls.ranges.filter(function (rg) {
                return !!rg[1]
            })); //exclude single char
            path.ranges = ranges;
            ...
            Object.keys(charMove).forEach(function (r) {
                ...
                trans.forEach(function (t) {
                    t.to.forEach(function (toState) {
                        if (t.eMove || ~transChar.indexOf(t)) transAll.push({
                            to: toState,
                            action: t.action,
                            assert: t.assert,
                            eMove: t.eMove
    ...
    function input(s, startIndex, _debug) {
        ...
        function _input(s, startIndex, fromState, stack, lastIndex) {
            recur: do {
                ...
                var sp = stack.length,
                    t, skip, ret, oldLastIndex = lastIndex;
